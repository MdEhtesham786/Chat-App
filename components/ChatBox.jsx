...
export default ChatBox = ({ avatar, name, friendID, userID }) => {
    ...
    return (
        <TouchableNativeFeedback onPress={() => navigation.navigate('Message', { userID, friendID })}>
            <View style={styles.box}>
                <Image style={styles.img} source={avatar} />
                <View style={styles.textContainer}>
                    <Text style={styles.name}>{name}</Text>
                    <Text style={styles.latestMessage}>{latestMessage ? latestMessage.message : 'Start a new conversation'}</Text>
                </View>
