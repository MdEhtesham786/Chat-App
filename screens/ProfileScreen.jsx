import { Text, View, SafeAreaView, TouchableOpacity, StyleSheet, Image, TextInput, BackHandler, Alert, TouchableWithoutFeedback, Keyboard, ActivityIndicator } from "react-native";
...
const ProfileScreen = ({ navigation, route }) => {
    ...
    const uploadImage = async (imageResult) => {
        ...
        try {
            const res = await axios.post('https://<your-backend-url>/upload-profile-pic', formData, {
                headers: {
